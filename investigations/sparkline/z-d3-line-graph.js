...
function sparkline(container, data, options) {
    ...
    d3.select("#sparkline-container").select("svg").remove();
...
const lineGraphContainer = document.getElementById("sparkline-container");
...
sparkline(lineGraphContainer, myData, myOptions);
//sparkline(lineGraphContainer, getModel().lineGraph, myOptions);
*/
