...
def dispatch_stream_to_fifo(twitterStreamRequest, fifo):
    ...
    # This is the main loop since we are single threaded.
    # Relying on the iter_lines() requests stream generator interface.
...
def main():
    ...
    state=State.RUNNING
    print(f"dispatch_stream_to_fifo() returns after ctrl-c");
